# adapted from /h/rgoyal/code/Mask2Former/mask2former_video/modeling/transformer_decoder/video_mask2former_transformer_decoder.py
...
class VideoMultiScaleMaskedTransformerDecoder(nn.Module):
    ...
    def forward(self, x, mask_features):
        ...
        out = {
            ...
            'pred_masks': predictions_mask[-1].squeeze(0).permute(1, 0, 2, 3),
    ...
    def _set_aux_loss(self, outputs_class, outputs_seg_masks):
        ...
        #     ]
        # else:
        return [{"pred_masks": b.squeeze(0).permute(1, 0, 2, 3)} for b in outputs_seg_masks[:-1]]
